...
namespace Engine
{
	...
	public static class Primitives2D
	{
		...
		private static void DrawPoints(Vector2 position, List<Vector2> points, Color color, float thickness)
		{
			if (points.Count < 2)
				return;
		...
		/// <param name="color">The color to draw the rectangle in</param>
		/// <param name="thickness">The thickness of the lines</param>
		public static void DrawRectangle(Rectangle rect, Color color, float thickness)
		{
		...
		/// <param name="size">The size of the rectangle</param>
		/// <param name="color">The color to draw the rectangle in</param>
		public static void DrawRectangle(Vector2 location, Vector2 size, Color color)
		{
		...
		public static void DrawRectangle(Vector2 location, Vector2 size, Color color, float thickness)
		{
		...
		/// <param name="color">The color to use</param>
		/// <param name="thickness">The thickness of the line</param>
		public static void DrawLine(Vector2 point1, Vector2 point2, Color color, float thickness)
		{
		...
		/// <param name="color">The color to use</param>
		public static void DrawLine(Vector2 point, float length, float angle, Color color)
		{
		...
		public static void DrawCircle(Vector2 center, float radius, int sides, Color color, float thickness)
		{
		...
		/// <param name="sides">The number of sides to generate</param>
		/// <param name="color">The color of the circle</param>
		public static void DrawCircle(float x, float y, float radius, int sides, Color color)
		{
		...
		/// <param name="color">The color of the circle</param>
		/// <param name="thickness">The thickness of the lines used</param>
		public static void DrawCircle(float x, float y, float radius, int sides, Color color, float thickness)
		{
		...
		public static void DrawArc(Vector2 center, float radius, int sides, float startingAngle, float radians, Color color)
		{
		...
		public static void DrawArc(Vector2 center, float radius, int sides, float startingAngle, float radians, Color color, float thickness)
		{
